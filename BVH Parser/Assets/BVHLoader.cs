...
public class JOINT
{
    ...
    public bool isRoot;
    public int channels_num;
    public List<float> channelOrder;
    public JOINT(string name, int _parent = 0, float x = 0f, float y = 0f, float z = 0f)
    {
        joint_name = name;
        ...
        offset_y = y;
        offset_z = z;
        channelOrder = new List<float> { 0, 1, 2, 3, 4, 5 }; //XYZp,XYZr
    }
...
public class BVHLoader : MonoBehaviour
{
    ...
    private string bvh_fname = "Assets\\BVH\\walk.bvh";
    ...
    void Update()
    {
        ...
        for (int i = 0; i < joints.Count; i++)
        {
            ...
            if (i == 0)
            {
                ...
                Vector3 current_rot = new Vector3(mat[frame_cnt, 3], mat[frame_cnt, 4], mat[frame_cnt, 5]);
            ...
            else
            {
                ...
                {
                    Vector3 current_rot = new Vector3(mat[frame_cnt, (name2idx[joints[i]] - 1) * 3 + 6], mat[frame_cnt, (name2idx[joints[i]] - 1) * 3 + 7], mat[frame_cnt, (name2idx[joints[i]] - 1) * 3 + 8]);
